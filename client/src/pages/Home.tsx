  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#A6CDC6] to-white text-black">
      ...
      <section className="container mx-auto px-6 py-12 grid md:grid-cols-2 gap-12">
        <div>
          <h2 className="text-3xl font-semibold mb-4">Stay on Top of Your Work</h2>
          <p className="text-lg">
            Our task management app helps you manage your workflow seamlessly.
            With features like deadlines, priorities, and reminders, you’ll never
            miss a task again.
          </p>
        </div>
      ...
      <section className="container mx-auto px-6 py-12 grid md:grid-cols-2 gap-12">
        <div>
          <h2 className="text-3xl font-semibold mb-4">Smart Reminders & Notifications</h2>
          <p className="text-lg">
      ...
      <section className="container mx-auto px-6 py-12 grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-lg">
            View your tasks in a clean and user-friendly dashboard. Customize your
            layout and organize your workload efficiently with ease.
          </p>
        </div>
      </section>
      
      <section className="text-center py-12">
        <h2 className="text-4xl font-semibold">Start Managing Your Tasks Today!</h2>
        <p className="mt-4 text-lg">Sign up now and take control of your productivity.</p>
        <button className="mt-6 px-6 py-3 bg-[#468585] text-white rounded-lg text-lg">Get Started</button>
      </section>
      
      <footer className="bg-[#468585] text-white py-6 text-center">
        <p className="text-sm">&copy; 2025 Task Manager. All rights reserved.</p>
      </footer>
    </div>
  );
};
